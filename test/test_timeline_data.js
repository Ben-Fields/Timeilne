...
console.log(gp_names);
console.assert(gp_names.length == 5);
console.assert(gp_names[2] == 'gp02');
...
console.assert(event01.groups.length == 3);
...
console.assert(event01.groups.length == 2);
...
console.assert(!test_gm.delete_group_by_id(gp01.getId())); // Does not force - Click "cancel" for valid test

console.assert(event01.groups.length == 2);
test_gm.delete_group_by_id(gp01.getId(), true); // force delete
console.assert(event01.groups.length == 1);
